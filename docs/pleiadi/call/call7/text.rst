...
.. centered:: (closing date 28/02/2026)
...
Both individual researchers and teams affiliated with research projects, such as European projects, PRIN projects, INAF mainstream projects, scientific missions, etc., may apply to the call.

In the case of applications submitted by INAF associates, it is mandatory that at least one INAF employee be included among the project collaborators.
...
The call in question offers a total of 10 million CORE hours, available starting from 01/04/2026. Proposals will be evaluated for the use of the computing e-infrastructure requesting a minimum of 100,000 CORE hours and up to a maximum of 500,000 CORE hours. 
...
As part of the renewal—in the process of being defined—of the agreement with Cineca, INAF offers 1.5 Million Standard Hours which will be usable from 01/04/2026. Proposals for computing resources requiring a minimum of 12,500 Standard Hours up to a maximum of 125,000 Standard Hours will be evaluated. The assigned computing resources will be available for up to a maximum of 6 months from the aforementioned date of first use.
In the context of this Call, the resources will be used on the Leonardo BOOSTER calculation system (https://docs.hpc.cineca.it/hpc/leonardo.html): please remember that 1 Standard Hour is equivalent to 1 CORE hour on Leonardo BOOSTER .
Projects can also require up to 4TB of work storage. Beyond these limits, additional disk resources may be requested (subject to verification of actual availability by Cineca). In this case the additional resources will be calculated as Equivalent Standard Hours considering that 1 TB/year on DRES or WORK is equivalent to 800 Standard Hours.
More information on CINECA storage systems can be found at https://docs.hpc.cineca.it/hpc/hpc_data_storage.html#file-systems-and-data-management
 

Long Term Storage (IA2)
----------------------

INAF provides long-term data storage spaces, even completely free from the need for computing resources. These long-term storage spaces will be made available starting from 01/04/2026. The typical dimensions of the spaces required in each individual proposal are from 1TB  to 20TB. Their use may continue until the date indicated and justified by the applicant.
...
Proposals must be submitted by completing the form available at the link: https://forms.gle/NL2rQtQ4xQVruuGYA  starting from 01/02/2026  and by 11.59pm on 28/02/2026.
...
Any allocated computing time that is not used within the authorized period will expire and cannot be automatically recovered. Any requests for an extension must be submitted in accordance with the procedures set out in the call and will be subject to evaluation.

Proposers will also be asked to specify the storage space necessary for the execution of the code, within the limits specified in the relevant section of the call. This storage, not subject to backup, will be available for up to 6 months from the end of the project, and is to be understood as functional for data production (i.e. it does not correspond to preservation storage). If long-term saving of the data produced is necessary, it will be necessary to submit a further and separate request, again via the proposal submission form, for the saving space on Tape Library IA2.

Similarly to what is provided for computing resources, the application for long-term data preservation space must contain all the data necessary for the evaluation of the request: size of preservation storage space requested; type, format and size of each scientific product; description of the structure of the collection; description of the expected frequency of access as well as the data access policy; any future plans for publishing the data; all information deemed relevant for correct data preservation following the FAIR principles.

Please note that, with regard to requests for data archiving at IA2 (i.e., not only data storage, but the inclusion of the data in a proper archive), this is not covered by this call. However, it will be possible to fill in the following form, providing all the information necessary to allow the request to be approved: https://docs.google.com/forms/d/1Xs3Spg7MVqA2ZZZadTbiz3dfIDshJzA5XSRGvJi7rVA.
